        ...
        <section class="w-full">
            ...
            <article class="w-full relative left-20 flex flex-col items-center justify-center lg:py-6 lg:px-8 xl:p-8" style="width: calc(100% - 80px)">
                <div class="flex items-center justify-center w-full mb-5">
                    <p class="uppercase text-black font-bold w-full text-center text-2xl lg:text-3xl">Pending Leave</p>
                </div>
                <RequestLeaveTable />
            </article>
        </section>
...
import RequestLeaveTable from '../components/RequestLeaveTable.vue';
