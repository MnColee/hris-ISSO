<template>
    <section class="w-full overflow-hidden">
        ...
        <div class="flex items-end justify-between w-full py-6 gap-x-10">
            <div class="flex flex-col gap-y-1 w-full lg:w-1/3">
            ...
            <div class="w-full lg:w-1/6">
                <button @click="toggleForms" type="button" class="flex items-center justify-center gap-x-2 rounded-lg py-2 w-full text-center bg-blue-600 text-white">
                ...
                <table ref="tables" class="w-full text-sm text-center">
                    <thead class="text-base font-bold border-b border-l border-r border-blue-600">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-1.5 lg:w-1/3">
                                File Name
                            </th>
                            <th scope="col" class="px-6 py-1.5 lg:w-1/2">
                                Date
                            </th>
                            <th scope="col" class="px-6 py-1.5 lg:w-full">
                                Action
                            </th>
                        </tr>
                    </thead>
                    ...
                    <tbody class="">
                        <tr class="border-t border-l border-r border-blue-600">
                            ...
                            <td scope="row" class="bg-tbody px-6 py-2">
    ...
    <AdminModal @close="toggleForms" :modalAdmin="modalForms">
        <div class="modal-content">
            <div class="modal-header lg:px-5 px-3 py-2">
                <h1 class="text-lg capitalize font-bold lg:text-xl">Add Forms</h1>
            </div>
...
const fileName = ref('');
const modalForms = ref(null);

const toggleForms = ()=>{
    modalForms.value = !modalForms.value
}
</script>
