<template>
    <nav class="bg-dashHead w-full py-2 flex items-center justify-end px-4 shadow-md lg:px-6">
        <ul class="flex items-center gap-x-4">
            ...
            <li class="relative">
                <button @click="toggleDropdown2" type="button" class="relative mt-2">
                    <img src="/img/photo.jpg" alt="admin-photo" class="rounded-full h-5 w-5 border border-white lg:h-7 lg:w-7">
                </button>
                <div v-show="dropdown2Open" class="notifMenu absolute top-auto right-0 w-40 shadow-md rounded-md z-50 bg-black">
                    <div class="flex flex-col">
                        <!--1-->
                        <RouterLink :to="{name: ''}" class="profile-setLink hover:bg-blue-100 cursor-pointer flex items-center justify-center gap-x-2 p-2 border-b border-blue-600">
                            <p class="text-sm">View Profile</p>
                        </RouterLink>
                        <RouterLink :to="{name: 'adminchangepassword'}" class="profile-setLink hover:bg-blue-100 cursor-pointer flex items-center justify-center gap-x-2 p-2 border-b border-blue-600">
                            <p class="text-sm">Change Password</p>
                        </RouterLink>
                        <RouterLink :to="{name: ''}" class=" hover:bg-blue-100 cursor-pointer flex items-center justify-center gap-x-2 p-2">
